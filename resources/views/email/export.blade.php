                ...
                <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="width:600px;max-width:600px">
                    <tr>
                        <td class="container-padding header" align="left" style="font-family:Helvetica, Arial, sans-serif;font-size:24px;font-weight:bold;padding-bottom:12px;color:#698836;padding-left:24px;padding-right:24px">
                            BUFALINDA USA - EXPORT DOCUMENTS
                        </td>
                    </tr>
                    <tr>
                        <td class="container-padding content" align="left" style="padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff">
                            <div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;color:#374550">Dear partner,</div>

                            <div class="body-text" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#333333">
                                <p> Please find attached all the document for your upcoming shipment.  
                                    <br>
                                    Please approve the documents in the system,  send them to your Customs Agent so the paperwork can be processed, and save a copy for your records.  
                                    <br><br>
                                    Regards,
                                    <br><br>
                                    Bufalinda USA
