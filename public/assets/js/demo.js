...
demo = {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                /*if (data == 1) {
                                    ...
                                    swal("Error", "El Archivo no puede ser liberado, falta informacion", "error");
                                }*/
                            }
                        });
    ...
    showUpdateSuccess: function(from, align){
        $.notify({
            icon: "notifications",
            message: "The state been modified"
    ...
    showSaveSuccess: function(from, align){
        $.notify({
            icon: "notifications",
            message: "The state been saved"
    ...
    showLiberarSuccess: function(from, align){
        $.notify({
            icon: "notifications",
            message: "<b>ALERT<b> <br> Can not be released lack of information"
    ...
    showErrorSuccess: function(from, align){
        $.notify({
            icon: "notifications",
            message: "<b>ALERT<b> <br> Can not move more than what exists in the warehouse"
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data == 1) {
                                ...
                                swal("Error", "It can not be eliminated, at least one element needs it.", "error");
                            }
                        }
                    });
                }
    ...
    showRelease: function(e,token,url){
        var id = e;
        console.log(id);
        console.log(url);
        swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url:url,
                        method: 'post',
                        data: {'id':id,'_token':token, _method: 'post', 'variable':3,},
                        success: function(data) {
                            console.log(data);
                            if (data == 1) {
                                swal({
                                    title: 'Release!',
                                    text: 'Remember to send your colleagues an email with the documentation!',
                                    type: 'success',
                                    confirmButtonClass: "btn btn-success",
                                    buttonsStyling: false,
                                    onClose: () => {
                                ...
                                swal("Error", "Can not be released, missing information.", "error");
                            }
                        }
                    });
                }
