...
//dd($inbound_order_all);
        ...
        return view('layouts.inventory.index', compact('inven_item','item','inventory', 'inbound_order', 'inv_loc', 'pallet', 'inbound_order_all', 'valores'));
    }
    ...
    public function sale(Request $request)
    {
        ...
        return view('layouts.inventory.sale', compact('customer','transport','inven_item','item','inventory', 'inbound_order_det', 'inbound_order', 'Warehouse', 'inv_loc', 'iund_order', 'delivery'));
    }
    ...
    public function transfer()
    {
        ...
        return view('layouts.inventory.transfers', compact('inven_item', 'inventory', 'inbound_order', 'wareh', 'inv_loc', 'item', 'collection', 'wareh_sin_airpot', 'pallet', 'warehouse_bodega', 'valores', 'document'));
    }
